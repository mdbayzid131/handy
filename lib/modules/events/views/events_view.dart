            ...
            return GestureDetector(
              ...
              child: Container(
                ...
                decoration: BoxDecoration(
                  color: isSelected ? const Color(0xFF132488) : const Color(0xFF1E2336),
                  borderRadius: BorderRadius.circular(20.r),
                  border: Border.all(
                    color: isSelected ? const Color(0xFF3B68E7) : Colors.white.withOpacity(0.1),
                    width: 1,
                  ),
                ),
            ...
            Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  Row(
                    children: [
                      Icon(Icons.location_on, color: Colors.white.withOpacity(0.5), size: 14.w),
                      SizedBox(width: 8.w),
                      Text(
                        event.location,
                        style: TextStyle(
