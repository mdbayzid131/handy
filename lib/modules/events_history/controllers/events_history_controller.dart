...
class EventsHistoryController extends GetxController {
  ...
  Future<void> fetchEvents({bool isRefresh = false}) async {
    ...
    try {
      String url = '${ApiConstants.eventsHistory}?page=$currentPage&limit=$limit';
      ...
      Helpers.showDebugLog('Error fetching history events: $e');
    } finally {
  ...
  Future<void> loadMoreEvents() async {
    ...
    try {
      ...
      Helpers.showDebugLog('Error fetching more history events: $e');
      currentPage--;
    } finally {
